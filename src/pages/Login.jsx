    ...
    <div className="min-h-screen bg-[#1a1a1a] text-white">
      ...
      <main className="flex items-center justify-center p-4 sm:p-8 min-h-[calc(100vh-200px)]">
        <div className="bg-[#2d2d2d] p-6 sm:p-8 rounded-lg border-2 border-[#4CAF50] w-full max-w-md animate-fadeIn">
          <h1 className="text-[#4CAF50] text-2xl sm:text-3xl mb-6 text-center">Вход в систему</h1>
          ...
          <p className="mt-4 text-center text-[#cccccc] text-sm">
            Нет аккаунта?{' '}
            <Link to="/register" className="text-[#4CAF50] hover:text-cyan-400 transition-colors">
              Зарегистрироваться
            </Link>
          </p>
          <p className="mt-2 text-center text-[#cccccc] text-xs">
            Тестовый вход: demo@example.com / password123
          </p>
        </div>
      </main>
      <Footer />
